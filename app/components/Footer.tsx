export default function Footer(){
    return(
        <>
        <div className="footer_main my-10 relative h-auto sm:h-96 ">  {/* faltu div*/}
        {/* absolute sm:top-5 sm:-right-10 md:top-3 lg:-top-2 md:right-10 lg:right-0 z-30 md:w-64 lg:w-96 h-96  */}
            {/* <div className="absolute sm:-right-6 md:right-0 z-30 h-full  sm:top-14 md:top-7 md2:top-4 lg:-top-3">
            <img src="./footer.png" alt="" className="md:h-full w-full lg:h-full transform object-cover" />
            </div> */}
            <div className="content px-10 w-full relative z-10 ">
                <div className="flex bg-emerald-200 rounded relative h-full"  > {/*emerald background */}
<div className="overlay bg-gradient-to-b from-white to-transparent opacity-60 z-20 absolute top-0 bottom-0 left-0 w-full h-4/6"></div>
                    ...
                    <div className=" sm:w-2/3 md:w-2/3 md2:w-2/3 lg:w-2/3 flex flex-col py-6 sm:px-4 md:px-3 lg:px-4 sm:h-96 justify-center relative z-10" > {/*content box left one  */}
                    ...
                    <div className="footer_image sm:w-1/3 md:w-1/3 md2:w-1/3 lg:w-1/3 h-96 hidden  relative sm:grid grid-cols-1 grid-rows-1  z-30 "> {/*content box-2 right one*/}
                     ...
                     <img src="./footer.png" alt="" className="md:h-full w-full h-full lg:h-full transform object-cover sm:translate-x-4 md2:translate-x-7 lg:translate-x-12  overflow-visible" />
                     </div>
